...
if ( ! function_exists( 'tahiti_setup' ) ) :
	/**
	...
	function tahiti_setup() {
		 ...
		 * If you're building a theme based on Tahiti, use a find and replace
		 * to change 'tahiti' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'tahiti' ),
			)
		);
